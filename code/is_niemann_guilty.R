...
hist(players$mahal_p, breaks = 100)
...
players.manova.3 <- manova(as.matrix(players[,3:4]) ~ players$Name2 * as.factor(players$Elo)) #testing if impact of Elo on responses depends on Name
